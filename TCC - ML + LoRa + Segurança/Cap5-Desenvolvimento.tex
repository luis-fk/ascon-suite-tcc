...
Para o desenvolvimento da camada de segurança com o padrão Ascon, o trabalho seguirá um roteiro de atividades práticas. O objetivo é organizar as etapas de implementação, validação e coleta de dados diretamente no hardware.
