...
O desenvolvimento da frente de aprendizado de máquina tem como objetivo
construir uma base experimental consistente para comparar diferentes abordagens
de regressão temporal aplicadas ao comportamento da rede LoRaWAN, abrangendo a
preparação dos dados, o treinamento dos modelos e a avaliação da capacidade de
detecção de anomalias. As atividades previstas para essa frente de trabalho são:
\begin{itemize}
...
A integração progressiva dessas camadas, tratadas como partes complementares de uma mesma solução, permite desenvolver o sistema com maior clareza, reduz a complexidade da implementação inicial e favorece a avaliação da arquitetura como um todo.
